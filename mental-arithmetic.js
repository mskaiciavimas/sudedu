...
const fireworksDiv = document.querySelector('#fireworks-div');
  ...
  function displayEquation () {
    ...
    fullEquationRowElement.innerHTML = '<label class="equation text-nowrap" for="answer-field"></label><div class="answer-field-div"><div id="answer-field" class="answer-field"><input type="text" id="answer" name="answer" class="form-control text-center answer-input" autocomplete="off"></div></div>'
